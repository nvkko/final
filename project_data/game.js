...
var txt_i = 0, timer = 0, step = 0, step2 = 0, link_time = false, font1 = 'font1';
//font1 = 'arial';
const G = {
...
function draw_step2(text) {
  ...
  if(timer%30 > 15) draw_text_with_len(x, y+line, text[i]+'_', text[i]+'_');
  else draw_text_with_len(x, y+line, text[i]+' ', text[i]+'_');
...
function draw_link(text) {
  ...
  if(timer > 15) draw_text_with_len(x, y+line, text[i]+'_', text[i]+'_');
  else draw_text_with_len(x, y+line, text[i]+' ', text[i]+'_');
  //if(timer > 15) c.fillText(text[i]+'_', x, y+line);
  //else c.fillText(text[i]+' ', x, y+line);
...
function draw_text_with_len(x, y, text1, text2){
  let w1 = c.measureText(text1).width, w2 = c.measureText(text2).width;
  ctx.fillText(text1, x-(w2-w1)/2, y);
}
